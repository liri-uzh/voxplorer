...
- [x] README
- [!] Check bug issue [issue #2](github.com/liri-uzh/voxplorer/issues/2)
- [!] **BUG: plot shape not reset to null after first selection** [issue #3](github.com/liri-uzh/voxplorer/issues/3) 
